...
class TestDoublyLinkedLists:
    ...
    def test_getitem_slice_inbounds(self) -> None:
        ...
        lst = DoublyLinkedList([0, 1, 2, 3, 4, 5, 6])
    ...
    def test_count_element_present(self) -> None:
        ...
        lst = DoublyLinkedList([0, 1, 2, 2, 4, 5, 6])
